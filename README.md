...
## ☁️ Бесплатный хостинг 24/7

Самый простой вариант — Render.

1. Зарегистрируйтесь на Render.
2. Создайте новый Web Service и подключите этот репозиторий.
3. В настройках сервиса добавьте переменную окружения:
   - `BOT_TOKEN=токен_вашего_бота`
4. Render автоматически запустит приложение через `Procfile`.

Это позволяет держать бота онлайн бесплатно в рамках бесплатного тарифа.
